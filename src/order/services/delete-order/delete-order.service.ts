...
import { DeleteOrderInterface } from '../../interface/delete-order.interface';
...
export class DeleteOrderService {
  ...
  async deleteOrder(orders: DeleteOrderInterface): Promise<string | Error> {
    // Find user by email
